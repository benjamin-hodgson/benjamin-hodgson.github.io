...
// - default languages + F#, Haskell, Prolog
...
;hljs.registerLanguage("bash",e)})();/*! `prolog` grammar compiled for Highlight.js 11.6.0 */
...
contains:g.concat([{begin:/\.$/}])}}})();hljs.registerLanguage("prolog",n)})();/*! `graphql` grammar compiled for Highlight.js 11.6.0 */
...
}),n,{begin:"->|<-"}]}}})();hljs.registerLanguage("haskell",e)})();/*! `fsharp` grammar compiled for Highlight.js 11.6.0 */
...
},h,m,E,_,v,p,d]}}})();hljs.registerLanguage("fsharp",e)})();/*! `xml` grammar compiled for Highlight.js 11.6.0 */
(()=>{var e=(()=>{"use strict";return e=>{

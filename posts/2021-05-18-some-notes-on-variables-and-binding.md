...
I've been thinking a bit about how to build a library to handle variables, capture-avoiding substitution, etc, on top of Sawmill. I'm a long way off having a final design, but I thought I'd publish my unfinished notes, hastily written in an afternoon. You'll see a few Thinking Emojis throughout this article, indicating things I haven't figured out yet. Please do get in touch if any of this gives you ideas.

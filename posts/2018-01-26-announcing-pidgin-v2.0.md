...
subtitle: Errors, speed, and `Span`
---
...
The good news is that it's never too late or too early to start building your own experience level, no matter where you are in your career. For me that meant setting myself the goal of making my open source libraries as fast as I could. Working on performance-focused libraries has been hugely rewarding for me, and learning how to write low-level C# has paid off at work. For you, it could mean picking a slow part of your codebase at work and trying to make it faster, or pair-programming with a colleague, or thoroughly reading through an existing highly optimised codebase. Making your own opportunities to learn new things is the best way to get better.
